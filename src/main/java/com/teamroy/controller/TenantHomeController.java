...
public class TenantHomeController {
    ...
    private void loadDashboardData(int tenantId) {
        RentAccrualService.applyChargesThroughToday(conn, tenantId);
        ...
        List<Announcement> announcements = announcementDao.GetActive().stream().limit(5).collect(Collectors.toList());
