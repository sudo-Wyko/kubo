...
public class PaymentDaoImpl implements PaymentDao {
    ...
    @Override
    public boolean updateStatusIfCurrent(int paymentId, String newStatus, String expectedCurrentStatus) {
        String sql = "UPDATE PAYMENT SET status = ? WHERE payment_id = ? AND status <=> ?";
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
